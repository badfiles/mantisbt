...
function filter_draw_selection_area() {
	# show filter block only to users who have 'filter_view_threshold' access level or above
	if( !access_compare_level( current_user_get_access_level(), config_get( 'filter_view_threshold' ) ) ) return;
