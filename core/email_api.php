 ...
 * @return integer|null
 */
function email_store( $p_recipient, $p_subject, $p_message, array $p_headers = null, $p_force = false, $p_bug_id = null ) {
	global $g_email_shutdown_processing;
...
function email_bug_info_to_one_user( array $p_visible_bug_data, $p_message_id, $p_user_id, array $p_header_optional_params = null ) {
	...
	# send mail
	email_store( $t_user_email, $t_subject, $t_message, $t_mail_headers, $t_bug_id );
